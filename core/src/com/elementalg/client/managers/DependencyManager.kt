...
class DependencyManager private constructor(private val assetManager: AssetManager,
     ...
     */
    override fun create() {
        val internalResolver: FileHandleResolver = InternalFileHandleResolver()

        assetManager.setLoader(FreeTypeFontGenerator::class.java, FreeTypeFontGeneratorLoader(internalResolver))
        assetManager.setLoader(BitmapFont::class.java, ".ttf", FreetypeFontLoader(internalResolver))
